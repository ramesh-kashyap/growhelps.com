/*!
 * beagle v1.0.0 (http://foxythemes.net/themes/beagle)
...
var App = function() {
    ...
    function b() {
        function a() {
            l.hasClass("be-fixed-sidebar") && c.perfectScrollbar("update")
        }
        var b = $(".sidebar-elements > li > a", m)
          , c = $(".left-sidebar-scroll", m)
          , d = $(".left-sidebar-toggle", m);
        b.on("click", function(b) {
            var c, d = $(this), e = i.leftSidebarSlideSpeed, f = d.parent(), g = d.next();
            c = f.siblings(".open"),
            c && c.find("> ul:visible").slideUp({
                duration: e,
                complete: function() {
                    c.toggleClass("open"),
        ...
        l.hasClass("be-fixed-sidebar") && (c.perfectScrollbar(),
    ...
    function c() {
        ...
        function b() {
            k.removeClass(i.openRightSidebarClass).addClass(i.transitionClass),
            d()
        }
        var c = $(".be-scroller", n);
    ...
    function e() {
        l.swipe({
            ...
            swipeLeft: function(a) {
                !o && n.length > 0 && (k.addClass(i.openRightSidebarClass + " " + i.transitionClass),
                o = !0)
            },
    ...
    function f() {
        ...
        function c(a, b) {
            ...
            "" != a && ($('<div class="msg">' + a + "</div>").appendTo(c),
            c.appendTo(i),
            j.stop().animate({
...
FastClick.prototype.sendClick = function(a, b) {
    ...
    e.initMouseEvent("mousedown", !0, !0, window, 1, f.screenX, f.screenY, f.clientX, f.clientY, !1, !1, !1, !1, 0, null ),
    e.forwardedTouchEvent = !0,
    a.dispatchEvent(e),
    d = document.createEvent("MouseEvents"),
    d.initMouseEvent("mouseup", !0, !0, window, 1, f.screenX, f.screenY, f.clientX, f.clientY, !1, !1, !1, !1, 0, null ),
    d.forwardedTouchEvent = !0,
    a.dispatchEvent(d),
    c = document.createEvent("MouseEvents"),
    c.initMouseEvent(this.determineEventType(a), !0, !0, window, 1, f.screenX, f.screenY, f.clientX, f.clientY, !1, !1, !1, !1, 0, null ),
...
FastClick.prototype.onTouchEnd = function(a) {
    ...
    !e || e.fastClickLastScrollTop === e.scrollTop)) || (this.needsClick(g) || (a.preventDefault(),
    this.sendClick(g, a)),
    !1)
}
,
...
!function() {
    ...
    function b(a) {
        ...
        "object" == typeof a && (a.hasOwnProperty("r") && a.hasOwnProperty("g") && a.hasOwnProperty("b") ? (b = c(a.r, a.g, a.b),
        f = !0,
        h = "%" === String(a.r).substr(-1) ? "prgb" : "rgb") : a.hasOwnProperty("h") && a.hasOwnProperty("s") && a.hasOwnProperty("v") ? (a.s = E(a.s),
        a.v = E(a.v),
        b = g(a.h, a.s, a.v),
        f = !0,
        h = "hsv") : a.hasOwnProperty("h") && a.hasOwnProperty("s") && a.hasOwnProperty("l") && (a.s = E(a.s),
        a.l = E(a.l),
        b = e(a.h, a.s, a.l),
        f = !0,
        h = "hsl"),
    ...
    function v(b, c) {
        c = c || 6;
        for (var d = a(b).toHsv(), e = d.h, f = d.s, g = d.v, h = [], i = 1 / c; c--; )
            h.push(a({
                h: e,
                s: f,
                v: g
    ...
    a.prototype = {
        ...
        getLuminance: function() {
            ...
            b = g.g / 255,
            c = g.b / 255,
            d = .03928 >= a ? a / 12.92 : Math.pow((a + .055) / 1.055, 2.4),
            e = .03928 >= b ? b / 12.92 : Math.pow((b + .055) / 1.055, 2.4),
            f = .03928 >= c ? c / 12.92 : Math.pow((c + .055) / 1.055, 2.4),
...
!function(a) {
    ...
    "use strict";
    function b(b) {
        return !b || void 0 !== b.allowPageScroll || void 0 === b.swipe && void 0 === b.swipeStatus || (b.allowPageScroll = k),
    ...
    function c(b, c) {
        function d(b) {
            if (!(ja() || a(b.target).closest(c.excludedElements, Ta).length > 0)) {
                ...
                if (!d.pointerType || "mouse" != d.pointerType || 0 != c.fallbackToMouseEvents) {
                    ...
                    ha(),
                    la(0, g),
                    !f || Va === c.fingers || c.fingers === t || R() ? (Xa = za(),
                    2 == Va && (la(1, f[1]),
                    Na = Oa = ta(Wa[0].start, Wa[1].start)),
                    (c.swipeStatus || c.pinchStatus) && (e = J(d, Ua))) : e = !1,
                    e === !1 ? (Ua = y,
                    J(d, Ua),
                    e) : (c.hold && (bb = setTimeout(a.proxy(function() {
            ...
            if (Ua !== x && Ua !== y && !ia()) {
                ...
                Va === c.fingers || c.fingers === t || !e || R()) {
                    ...
                    !c.triggerOnTouchEnd || c.triggerOnTouchLeave) {
                        ...
                        !c.triggerOnTouchEnd && h ? Ua = I(w) : c.triggerOnTouchLeave && !h && (Ua = I(x)),
                        Ua != y && Ua != x || J(b, Ua)
                    }
                } else
                    Ua = y,
        ...
        function E(a) {
            ...
            Ma = sa(),
            M() || !L() ? (Ua = y,
            J(b, Ua)) : c.triggerOnTouchEnd || c.triggerOnTouchEnd === !1 && Ua === w ? (c.preventDefaultEvents !== !1 && a.preventDefault(),
            Ua = x,
            J(b, Ua)) : !c.triggerOnTouchEnd && Y() ? (Ua = x,
            K(b, Ua, o)) : Ua === w && (Ua = y,
            J(b, Ua)),
            ka(!1),
            null
        ...
        function I(a) {
            var b = a
              ...
              , e = L()
              , f = M();
            return !d || f ? b = y : !e || a != w || c.triggerOnTouchEnd && !c.triggerOnTouchLeave ? !e && a == x && c.triggerOnTouchLeave && (b = y) : b = x,
            b
        }
        function J(a, b) {
            var c, d = a.touches;
            return (V() || U()) && (c = K(a, b, m)),
            (S() || R()) && c !== !1 && (c = K(a, b, n)),
        ...
        function K(b, d, k) {
            var l;
            if (k == m) {
                if (Ta.trigger("swipeStatus", [d, Ka || null , Ja || 0, Ma || 0, Va, Wa, La]),
                c.swipeStatus && (l = c.swipeStatus.call(Ta, b, d, Ka || null , Ja || 0, Ma || 0, Va, Wa, La),
                l === !1))
                    return !1;
                if (d == x && T()) {
                    if (clearTimeout(ab),
                    ...
                    c.swipe && (l = c.swipe.call(Ta, b, Ka, Ja, Ma, Va, Wa, La),
                    l === !1))
                        return !1;
                    switch (Ka) {
                    case e:
                        Ta.trigger("swipeLeft", [Ka, Ja, Ma, Va, Wa, La]),
                        c.swipeLeft && (l = c.swipeLeft.call(Ta, b, Ka, Ja, Ma, Va, Wa, La));
                        break;
                    case f:
                        Ta.trigger("swipeRight", [Ka, Ja, Ma, Va, Wa, La]),
                        c.swipeRight && (l = c.swipeRight.call(Ta, b, Ka, Ja, Ma, Va, Wa, La));
                        break;
                    case g:
                        Ta.trigger("swipeUp", [Ka, Ja, Ma, Va, Wa, La]),
                        c.swipeUp && (l = c.swipeUp.call(Ta, b, Ka, Ja, Ma, Va, Wa, La));
                        break;
                    case h:
                        Ta.trigger("swipeDown", [Ka, Ja, Ma, Va, Wa, La]),
                        c.swipeDown && (l = c.swipeDown.call(Ta, b, Ka, Ja, Ma, Va, Wa, La))
                    }
                }
            }
            if (k == n) {
                if (Ta.trigger("pinchStatus", [d, Ra || null , Qa || 0, Ma || 0, Va, Pa, Wa]),
                c.pinchStatus && (l = c.pinchStatus.call(Ta, b, d, Ra || null , Qa || 0, Ma || 0, Va, Pa, Wa),
                l === !1))
                    return !1;
                if (d == x && Q())
                    switch (Ra) {
                    case i:
                        Ta.trigger("pinchIn", [Ra || null , Qa || 0, Ma || 0, Va, Pa, Wa]),
                        c.pinchIn && (l = c.pinchIn.call(Ta, b, Ra || null , Qa || 0, Ma || 0, Va, Pa, Wa));
                        break;
                    case j:
                        Ta.trigger("pinchOut", [Ra || null , Qa || 0, Ma || 0, Va, Pa, Wa]),
                        c.pinchOut && (l = c.pinchOut.call(Ta, b, Ra || null , Qa || 0, Ma || 0, Va, Pa, Wa))
                    }
            }
            return k == o ? d !== y && d !== x || (clearTimeout(ab),
            clearTimeout(bb),
            Z() && !aa() ? (_a = za(),
            ab = setTimeout(a.proxy(function() {
                _a = null ,
                Ta.trigger("tap", [b.target]),
                c.tap && (l = c.tap.call(Ta, b, b.target))
            }, this), c.doubleTapThreshold)) : (_a = null ,
            Ta.trigger("tap", [b.target]),
            c.tap && (l = c.tap.call(Ta, b, b.target)))) : k == p ? d !== y && d !== x || (clearTimeout(ab),
            clearTimeout(bb),
            _a = null ,
            Ta.trigger("doubletap", [b.target]),
            c.doubleTap && (l = c.doubleTap.call(Ta, b, b.target))) : k == q && (d !== y && d !== x || (clearTimeout(ab),
            _a = null ,
        ...
        function M() {
            var a = !1;
            return null !== c.cancelThreshold && null !== Ka && (a = pa(Ka) - Ja >= c.cancelThreshold),
            a
        }
        function N() {
        ...
        function ka(a) {
            Ta && (a === !0 ? (Ta.bind(Fa, D),
            Ta.bind(Ga, E),
            Ha && Ta.bind(Ha, G)) : (Ta.unbind(Fa, D, !1),
            Ta.unbind(Ga, E, !1),
            Ha && Ta.unbind(Ha, G, !1)),
        ...
        function la(a, b) {
            ...
            return c.start.x = c.last.x = c.end.x = b.pageX || b.clientX,
    ...
    return App.dashboard = function() {
        ...
        function b() {
            $(".toggle-loading").on("click", function() {
                ...
                a.length && (a.addClass("be-loading-active"),
                setTimeout(function() {
        ...
        function c() {
            ...
            $("#spark5").sparkline([5, 8, 7, 10, 9, 10, 8, 6, 4, 6, 8, 7, 6, 8], {
                type: "bar",
                width: "85",
                height: "35",
                barWidth: 3,
            ...
            $("#spark6").sparkline([2, 3, 4, 5, 4, 3, 2, 3, 4, 5, 6, 5, 4, 3, 4, 5, 6, 5, 4, 4, 5], {
                type: "discrete",
                width: "85",
                height: "35",
                lineHeight: 20,
            ...
            $("#spark7").sparkline([2, 5, 3, 7, 5, 10, 3, 6, 5, 7], {
                width: "85",
                height: "35",
                lineColor: d,
                highlightSpotColor: d,
            ...
            $("#spark8").sparkline([5, 8, 7, 10, 9, 10, 8, 6, 4, 6, 8, 7, 6, 8], {
                type: "bar",
                width: "85",
                height: "35",
                barWidth: 3,
            ...
            $("#spark9").sparkline([2, 3, 4, 5, 4, 3, 2, 3, 4, 5, 6, 5, 4, 3, 4, 5, 6, 5, 4, 4, 5], {
                type: "discrete",
                width: "85",
                height: "35",
                lineHeight: 20,
            ...
            $("#spark10").sparkline([2, 5, 3, 7, 5, 10, 3, 6, 5, 7], {
                width: "85",
                height: "35",
                lineColor: d,
                highlightSpotColor: d,
