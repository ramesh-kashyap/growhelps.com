...
jQuery(document).ready(function(e) {
	...
	jQuery('#userData').html('<span class="load-gif"><img style="width: 100%;" src="{{asset("aseets/images/load.gif")}}">&nbsp;System calculating reports</span>');
  ...
  console.log(response);
     ...
     jQuery('#userData').html('<table><tr><td><span>Right Team :</span> <br/> <i class="fa fa-user-secret" aria-hidden="true"></i>'+  RightUser +'</td><td><span>Right PV :</span> <br/> '+RightBusiness+'</td><td><span>My Package :</span> <br/> &#8377; '+todayRightBusiness+'</td></tr><tr><td><span>Left Team :</span> <br/> <i class="fa fa-user-secret" aria-hidden="true"></i>'+leftUser +'</td><td><span>Left PV :</span> <br/> </i>'+leftBusiness+'</td><td><span>Join Date :</span> <br/> '+todayLeftBusiness+'</td></tr></table>');
