 @include('layouts.upnl.header')
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Leadership Bonus</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Leadership Bonus</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
   ...
   <form action="{{ route('global-community-bonus') }}" method="GET">
         ...
         <a href="{{ route('global-community-bonus') }}" name="reset" class="btn btn-primary btn-sm" value="Reset" />Reset</a>
            </div>
        </form>
        <br>
