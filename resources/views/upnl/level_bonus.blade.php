@include('layouts.upnl.header')
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Performance Bonus</li>
                                        </ol>
                                    </div>
    ...
    <form action="{{ route('level-bonus') }}" method="GET">
         ...
         <a href="{{ route('level-bonus') }}" name="reset" class="btn btn-primary btn-sm" value="Reset" />Reset</a>
            </div>
        </form>
        <br>
