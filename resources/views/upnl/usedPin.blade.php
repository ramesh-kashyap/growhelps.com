@include('layouts.upnl.header')
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Used Pin Report</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Used Pin Report</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                              ...
                              <div class="row">
                                <div class="col-12">
                                    <div class="card-box table-responsive">
                                           ...
                                           <form action="{{ route('Used-pin') }}" method="GET">
         ...
         <a href="{{ route('Used-pin') }}" name="reset" class="btn btn-primary btn-sm" value="Reset" />Reset</a>
            </div>
        </form>
        <br>
