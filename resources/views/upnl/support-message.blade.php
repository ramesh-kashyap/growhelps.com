@include('layouts.upnl.header')
    ...
    <form action="{{ route('support-message') }}" method="GET">
         ...
         <a href="{{ route('support-message') }}" name="reset" class="btn btn-primary btn-sm" value="Reset" />Reset</a>
            </div>
        </form>
        <br>
                                                      ...
                                                      <?php $cnt =$level_income->perPage() * ($level_income->currentPage() - 1); ?>
                                                       @foreach($level_income as $value)
                                                        <tr>
                                                           ...
                                                           <td><a href="{{route('viewMessage')}}?ticket_no={{$value->ticket_no}}"><button style="color:#000;border:1px solid #000;padding:8px;border-radius:15px">View all message</button></a></td>
