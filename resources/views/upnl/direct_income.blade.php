@include('layouts.upnl.header')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Level Bonus</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
    ...
    <form action="{{ route('direct-bonus') }}" method="GET">
         ...
         <a href="{{ route('direct-bonus') }}" name="reset" class="btn btn-primary btn-sm" value="Reset" />Reset</a>
            </div>
        </form>
        <br>
