  ...
  @include('layouts.upnl.header')
    ...
    <div class="content-page">
                <div class="content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Left Users</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                    ...
                    <form action="{{ route('Left-users') }}" method="GET">
         ...
         <a href="{{ route('Left-users') }}" name="reset" class="btn btn-primary btn-sm" value="Reset" />Reset</a>
            </div>
        </form>
        <br>
