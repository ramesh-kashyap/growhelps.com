@include('layouts.upnl.header')
    ...
    <div class="content-page">
                <div class="content">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Direct Users</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Direct Users</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                    ...
                    <form action="{{ route('direct-users') }}" method="GET">
         ...
         <a href="{{ route('direct-users') }}" name="reset" class="btn btn-primary btn-sm" value="Reset" />Reset</a>
            </div>
        </form>
        <br>
