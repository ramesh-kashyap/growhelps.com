                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Transfer Pin Report</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Transfer Pin Report</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                              ...
                              <div class="row">
                                <div class="col-12">
                                    <div class="card-box table-responsive">
                                           ...
                                           <form action="{{ route('pintransfered') }}" method="GET">
         ...
         <a href="{{ route('pintransfered') }}" name="reset" class="btn btn-primary btn-sm" value="Reset" />Reset</a>
            </div>
        </form>
        <br>
