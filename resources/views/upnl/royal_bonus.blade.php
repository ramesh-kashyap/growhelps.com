 @include('layouts.upnl.header')
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Royal Magic Bonus</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Royal Magic Bonus</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
   ...
   <form action="{{ route('royal-bonus') }}" method="GET">
         ...
         <a href="{{ route('royal-bonus') }}" name="reset" class="btn btn-primary btn-sm" value="Reset" />Reset</a>
            </div>
        </form>
        <br>
