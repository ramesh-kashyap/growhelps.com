  ...
  @include('layouts.upnl.header')
    ...
    <div class="content-page">
                <div class="content">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Right Users</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Right Users</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                    ...
                    <form action="{{ route('Right-users') }}" method="GET">
         ...
         <a href="{{ route('Right-users') }}" name="reset" class="btn btn-primary btn-sm" value="Reset" />Reset</a>
            </div>
        </form>
        <br>
