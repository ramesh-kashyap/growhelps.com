...
<div class="customer-wrapper">
  ...
  @if(session()->has('messages'))
                        <?php 
                                      ...
                                      <div id="successfull" style="">
                            <div class="text-center">
                                <h2 class="text-success">Congratulation</h2>
                              
                              
                                  
                                  <h4 style="color:#000;">Welcome to <span class="main-color">Grow helps</span> Thank You for choosing us. We wish you best of luck for your bright future.</h4>
                                  <h4 style="color:#000;">Dear <span class="main-color">
                                 {{$user_details['name']  }}
                                    </span>,</h4>
                                  <h4 style="color:#000;">congratulations ! Your Registration  was Successful. <br>
                                    Your user id is <span class="main-color" style="color: #f5b120;
                            font-weight: bold;">
                                  {{$user_details['username']  }}
                                    </span> And Password is <span class="main-color" style="color: #f5b120;
                            font-weight: bold;">
                                    {{$user_details['PSR']  }}
                                    </span> please check your mail for more details.</h4>
