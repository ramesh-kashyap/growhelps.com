 ...
 <link rel="stylesheet" href="{{ asset('admin/assets/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css') }}">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <br>
           <form  method="GET" action="{{route('edit_users')}}">
                  ...
                  <a href="{{ route('edit_users') }}" name="reset" class="btn btn-primary btn-sm" value="Reset" />Reset</a>
                    </div>
                </form>
    </section>
                ...
                <?php $cnt =$active_user->perPage() * ($active_user->currentPage() - 1); ?>
                 @foreach($active_user as $value)
                  <tr>
                      ...
                      <td ><a href="{{route('edit_users_link')}}?id={{$value->id}}" class="badge green" style="    background: green;">Edit User</a></td>
