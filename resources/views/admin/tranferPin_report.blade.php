  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       ...
       <br>
           <form  method="GET" action="{{route('tranfer-pin-Report')}}">
                  ...
                  <a href="{{ route('tranfer-pin-Report') }}" name="reset" class="btn btn-primary btn-sm" value="Reset" />Reset</a>
                    </div>
                </form>
    </section>
